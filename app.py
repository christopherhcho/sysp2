    ...
    api_request_payload = {
        ...
        "messages": [
            {"role": "system", "content": 
             """
            #Instruction     
            - 이 GPT는 사용자가 입력한 eDM 내용을 검토하고 피드백하는 용도로 만들어졌으며, 1. 입력되는 데이터를 받아 고객 친화적인 용어와 어조로 수정하고 수정된 응답을 제공합니다.
            #Context  
            ...
            - 이모지, 이모티콘은 절대 포함하지 말아주세요.
            - 본문에 '**' 과 같은 마크다운 양식은 절대로 포함하지 말아주세요.
            #Example
